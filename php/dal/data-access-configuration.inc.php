<?php
   ...
   This file defines a global array named $dalSettings that you'll use
   when connecting to the database. By putting these settings in a PHP
   "include file", you can set them in just one place, no matter how
