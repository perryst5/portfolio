...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="box-product product-list list-layout">
    ...
    <div>
      ...
      <div class="image"><a href="<?php echo $product['href']; ?>" style="<?php echo ($thumb_height < 224) ? 'line-height: 224px' : ''; ?>"><img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" /></a></div>
      <?php } else { ?>
      <div class="image">
        <span class="no-image" style="<?php echo ($thumb_width < 224) ? 'width: 224px' : 'width: '.$thumb_width.'px'; ?>; <?php echo ($thumb_height < 224) ? 'line-height: 224px' : 'line-height: '.$thumb_height.'px;'; ?>">
