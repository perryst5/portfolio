...
class ControllerModuleMagicZoomPlus extends Controller {
    ...
    public function index () {
            ...
            /*STANDARD CODE*/
            //$this->load->language('module/magiczoomplus'); // load lang. file
            ...
            $this->data['total_items'] = $cacheInfo['totalCount'].' ('.$this->MagicZoomPlusformat_size($cacheInfo['totalSize']).')';
            $this->data['unused_items'] = $cacheInfo['unusedCount'].' ('.$this->MagicZoomPlusformat_size($cacheInfo['unusedSize']).')';
            ...
            $this->data['action'] = HTTPS_SERVER . 'index.php?route=module/magiczoomplus' . $token;

            $this->data['cancel'] = HTTPS_SERVER . 'index.php?route=extension/module' . $token;

            if (isset($this->request->post['magiczoomplus_status'])) {
                    $this->data['magiczoomplus_status'] = $this->request->post['magiczoomplus_status'];
            } else {
                    $this->data['magiczoomplus_status'] = $this->config->get('magiczoomplus_status');
            }

            $this->template = 'module/magiczoomplus.tpl';
            $this->children = array(
                    'common/header',
                    'common/footer'
            );
