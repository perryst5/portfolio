...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <div class="container">
		<div class="text-center"><h1>Lab 5</h1></div>
		<hr class="title">
		<div class="row">
			<div class="col-xs-6 col-sm-offset-3 col-md-offset-3 col-lg-offset-3 text-center well">
				<form method="post">
					...
					<div><textarea name="feedback" cols="30" rows="4" class="form-control" style="width:50%;margin:0 auto;" value="<?php echo $_POST['feedback']; ?>"></textarea></div><br />
					<input type="submit" name="submit" value="Submit" class="btn btn-submit">
				</form>
				<br><br>
				<?php 
				if (isset($_POST['submit'])) {
					require("lab5/connect.php");
					...
					$SQL="INSERT INTO lab5 (firstname, lastname, mail, sex, price, feedback) values('$firstname','$lastname','$mail','$sex','$price','$feedback')";
					
				    if (mysql_query($SQL)) {
					echo "<p>Thank you $firstname!  You have been added to our database. <a href=\"lab5/table-results.php\">View the database.</a></p>";
				    } else {
				...
				mysql_close($connect);
					...
					echo "<p>Please complete the form above and click \"Submit\", or <a href=\"lab5/table-results.php\">view the database.</a></p>";
				}
				?> 
			</div>
		</div>  	
